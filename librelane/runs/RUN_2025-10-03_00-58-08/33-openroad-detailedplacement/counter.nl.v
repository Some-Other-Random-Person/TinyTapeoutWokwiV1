module counter (clk_i,
 ...
 sky130_fd_sc_hd__nor3_1 _37_ (.A(net1),
    ...
    .C(_18_),
    .Y(_07_));
 sky130_fd_sc_hd__dfxtp_4 _38_ (.CLK(clk_i),
    .D(_00_),
    .Q(counter_val_o[6]));
 sky130_fd_sc_hd__dfxtp_2 _39_ (.CLK(clk_i),
    .D(_01_),
    .Q(counter_val_o[7]));
 sky130_fd_sc_hd__dfxtp_4 _40_ (.CLK(clk_i),
    .D(_02_),
    .Q(counter_val_o[0]));
 sky130_fd_sc_hd__dfxtp_4 _41_ (.CLK(clk_i),
    .D(_03_),
    .Q(counter_val_o[1]));
 sky130_fd_sc_hd__dfxtp_4 _42_ (.CLK(clk_i),
    .D(_04_),
    .Q(counter_val_o[2]));
 sky130_fd_sc_hd__dfxtp_2 _43_ (.CLK(clk_i),
    .D(_05_),
    .Q(counter_val_o[3]));
 sky130_fd_sc_hd__dfxtp_4 _44_ (.CLK(clk_i),
    .D(_06_),
    .Q(counter_val_o[4]));
